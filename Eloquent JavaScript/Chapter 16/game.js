/* Juego plataformero usando DOM donde el juagdor debe buscar monedas saltando. Sobre
objetos y evitando la lava. Todo se hará mediante fiaguras y niveles creados
a partir de rejillas en formato de texto. Se usarán figuras geométricas que 
simularán los objetos del juego. Los objetos movibles (ACTORES) serán clases (Player, Lava,
Coin) y los estáticos serán las paredes, espacios vacios */
...
let simpleLevel = new Level(level1);
